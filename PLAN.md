...
3. macOS integration: menu-bar countdown, wake refresh, optional UserNotifications, completion sound, optional ServiceManagement launch at login. No network, accounts, or third-party packages.
4. Validation: deterministic timer regression tests, debug and optimized builds, Specific config check, Specific dev launch, native UI interaction checks and screenshot, installed bundle signature/process check.
5. Delivery: locally ad-hoc signed /Applications/FocusBar.app, complete source and repeatable build instructions. Apple notarization and distribution are outside this personal build.
